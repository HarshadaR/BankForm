package com.example.sourabh.bankform;
...
import com.example.sourabh.bankform.Adapter.StudentAdapter;
import com.example.sourabh.bankform.Database.StudentTable;
import com.example.sourabh.bankform.databinding.ActivityStudentListBinding;
...
public class StudentList extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        adapter.setOnButtonClickedListener(new OnButtonClickedListener() {
            @Override
            protected void onClick(View view, final int position) {
                switch (view.getId()) {
                    case R.id.btnEdit:
